...
if(isset($_POST['user_name']) and isset($_POST['user_phone'])) {
  ...
  $mail->Body    = '<p>Пользователь <b>' .$name . '</b> скачала полное описание и цены программ, а также оставила телефон: <b>' . $phone . '</b></p><br /><br />Это сообщение было сформировано автоматически.';
  $mail->AltBody = '';
